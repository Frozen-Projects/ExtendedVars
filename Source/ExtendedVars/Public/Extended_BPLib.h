...
UCLASS()
class EXTENDEDVARS_API UExtendedVarsBPLibrary : public UBlueprintFunctionLibrary
{
...
#pragma region Fonts_Group
	...
	static URuntimeFont* Runtime_Font_Load(TArray<uint8> In_Bytes, FString FontName = "RuntimeFont");
...
#pragma region Sorters
	...
	static TArray<FString> Sort_String(TArray<FString> TargetArray, bool bIsDescending);
	...
	static TArray<int32> Sort_Int32(TArray<int32> TargetArray, bool bIsDescending);
	...
	static TArray<float> Sort_Float(TArray<float> TargetArray, bool bIsDescending);
	...
	static TArray<double> Sort_Double(TArray<double> TargetArray, bool bIsDescending);
	...
	static TArray<FDateTime> Sort_Time(TArray<FDateTime> TargetArray, bool bIsDescending);
...
#pragma region Read_Group
	...
	static FString Android_Path_Helper(FString In_FileName);
	...
	static bool Get_Folder_Contents(TArray<FFolderContents>& OutContents, FString& ErrorCode, FString InPath);
	...
	static void Search_In_Folder(FDelegateFolderContents DelegateFolderContents, FString InPath, FString InSearch, bool bSearchExact);
	...
	static bool Read_File_From_Path_64(UBytesObject_64*& Out_Bytes_Object, FString In_Path, bool bUseLowLevel = false);
	...
	static bool Read_File_From_Path_32(TArray<uint8>& Out_Bytes, FString In_Path, bool bUseLowLevel = false);
	...
	static bool Read_Text_From_Path(FString& Out_String, FString In_Path);
...
#pragma region Write_Group
	...
	static bool Write_File_To_Path(FString& Out_Code, TArray<uint8> In_Bytes, FString In_Path);
...
#pragma region Bytes_Group
	...
	static FString Bytes_x86_To_Hex(TArray<uint8> In_Bytes, int32 Hex_Start, int32 Hex_End, bool bIsFull);
	...
	static FString Bytes_x86_To_Base64(TArray<uint8> In_Bytes, bool bUseUrl);
	...
	static FString Bytes_x86_To_UTF8(TArray<uint8> In_Bytes);
	...
	static TArray<uint8> Hex_To_Bytes_x86(FString In_Hex);
	...
	static TArray<uint8> UTF8_To_Bytes_x86(FString In_UTF8);
	...
	static TArray<uint8> Base64_To_Bytes_x86(FString In_Base, bool bUseUrl);
	...
	static EImageExtensions DetectImageExtension(TArray<uint8> In_Bytes);
...
#pragma region String_Group
	...
	static FString FDateTime_To_String(FDateTime In_Time, FString CustomFormat, bool bUseIso8601 = true);
	...
	static FString Int64_To_String(int64 TargetInt64);
	...
	static bool String_To_Int32(int32& Out_Int32, FString SourceString);
	...
	static bool String_To_Int64(int64& Out_Int64, FString SourceString);
	...
	static bool String_To_Double(double& Out_Double, FString SourceString);
	...
	static bool String_To_Float(float& Out_Float, FString SourceString);
	...
	static bool String_To_Hex(FString& Out_Hex, FString SourceString, bool bIsLower);
	...
	static bool String_To_Base64(FString& Out_Base64, FString SourceString, bool bUseUrl);
	...
	static bool Hex_To_String(FString& Out_Decoded, FString In_Hex);
	...
	static bool Base64_To_String(FString& Out_Decoded, FString In_Hex, bool bUseUrl);
	...
	static FString Merge_Map_To_String(const TMap<FString, FString>& In_Map);

#pragma endregion String_Group

#pragma region JSON_Group

	static bool StringToJsonObjectArray(TArray<TSharedPtr<FJsonValue>>& OutArray, const FString& InJsonArrayString);
	...
	static FString PrintJsonObjectArray(TArray<FJsonObjectWrapper> In_Objects);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Element From Json Object Array", Keywords = "json, get, object, array, element"), Category = "Frozen Forest|Extended Variables|JSON")
	static FJsonObjectWrapper GetElementFromJsonObjectArray(TArray<FJsonObjectWrapper> In_Objects, int32 Index);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Object Array Field From String", Keywords = "json, get, object, array, field, from, string"), Category = "Frozen Forest|Extended Variables|JSON")
	static TArray<FJsonObjectWrapper> GetObjectArrayFieldFromString(const FString& JsonString, const FString& FieldName);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Object Array Field From Object", Keywords = "json, get, object, array, field, from"), Category = "Frozen Forest|Extended Variables|JSON")
	static TArray<FJsonObjectWrapper> GetObjectArrayFieldFromObject(FJsonObjectWrapper In_Object, const FString& FieldName);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Value Array Field From String", Keywords = "json, get, value, array, field, from, string"), Category = "Frozen Forest|Extended Variables|JSON")
	static TArray<FString> GetValueArrayFieldFromString(const FString& JsonString, const FString& FieldName);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Value Array Field From Object", Keywords = "json, get, value, array, field, from, object"), Category = "Frozen Forest|Extended Variables|JSON")
	static TArray<FString> GetValueArrayFieldFromObject(FJsonObjectWrapper In_Object, const FString& FieldName);
...
#pragma region Int_Group
	...
	static uint8 Int32_To_Byte(int32 In_Number);
	...
	static int32 Int32_Place_Family(int32 TargetInteger);
	...
	static int32 Int32_Truncate_To_Big(int32 TargetInteger);
	...
	static int32 Int32_Truncate_To_Small(int32 TargetInteger);
...
#pragma region Float_Group
	...
	static double Float_Precision(double TargetFloat, int32 Precision);
	...
	static int32 Float_Fraction_Count(float TargetFloat);
	...
	static float Float_Round_Next(float TargetFloat, double Decimal);
...
#pragma region Time_Group
	...
	static FDateTime Increment_Date(FDateTime Start, int32 In_Years, int32 In_Months, int32 In_Days);
...
#pragma region Render_Group
	...
	static EGammaSpace ConvertGammaSpace(EGammaSpaceBp InGammaSpaceBp);

	static bool Encode_New_Internal(TArray<uint8>& Out_Buffer, FString& Out_Code, TArray<uint8> Texture_Data, FVector2D ImageRes, EImageExtensions CompressFormat, EGammaSpaceBp GammaSpaceBp);
	static bool Encode_Old_Internal(TArray<uint8>& Out_Buffer, FString& Out_Code, TArray<uint8> Texture_Data, FVector2D ImageRes, EImageExtensions CompressFormat);
	static bool GetTextureBuffer_Internal(TArray<uint8>& Out_Bytes, FString& Out_Code, UTexture* In_Texture, FRHICommandListImmediate* RHICmdList);
	...
	static UTextureRenderTarget2D* Widget_To_TRT2D(FString& OutCode, UUserWidget* InWidget, FVector2D InDrawSize);
	...
	static EGammaSpaceBp GetGammaSpace(UTexture* In_Texture);
	...
	static FVector2D GetTextureSize(UTexture* In_Texture);
	...
	static void TRT2D_To_T2D(FDelegateTexture2D Delegate_T2D, UTextureRenderTarget2D* In_TRT_2D);
	...
	*/
	...
	static bool Export_Texture_File(FString& Out_Path, TArray<uint8> ImageBuffer, FVector2D ImageRes, FString In_Path, EGammaSpaceBp GammaSpaceBp, EImageExtensions Extension = EImageExtensions::Ext_BMP);
	...
	static bool Export_T2D_Colors(TArray<FColor>& Out_Array, FString& Out_Code, UTexture2D* Texture);
	...
	static bool Export_T2D_Bytes(TArray<uint8>& Out_Array, FString& Out_Code, UTexture2D* Texture);

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Export Texture with GPU", Keywords = "t2d, trt2d, texture, texture2d, utexture2d, render, target, media, get, export, byte, bytes, buffer, array, gpu"), Category = "Frozen Forest|Extended Variables|Render")
	static void Export_Texture_Bytes_GPU(FDelegateImageBuffer DelegateImageBuffer, UTexture* TargetTexture);
	...
	static void Export_Texture_Bytes_RT(FDelegateImageBuffer DelegateImageBuffer, UTexture* TargetTexture);
	...
	static void EncodeTexture(FDelegateImageBuffer DelegateImageBuffer, TArray<uint8> Texture_Data, FVector2D ImageRes, EImageExtensions CompressFormat, EGammaSpaceBp GammaSpaceBp, bool bUseOldApi);
	...
	static void DecodeTexture(FDelegateImageBuffer DelegateImageBuffer, TArray<uint8> In_Bytes);
	...
	static bool Import_T2D_Bytes(UTexture2D*& Out_Texture, TArray<uint8> In_Bytes, bool bUseSrgb);
	...
	static bool Import_T2D_Bytes_LowLevel(UTexture2D*& Out_Texture, TArray<uint8> In_Bytes, FVector2D Size, bool bUseSrgb);
	...
	*/
	...
	static double GetPaintRatio(UCanvasRenderTarget2D* InCRT, FLinearColor InWantedColor, uint8 Tolerance = 1, bool bLogEachColor = false);
...
#pragma region System
	...
	static bool ReplaceObject(UPARAM(ref)UObject*& Old, UPARAM(ref)UObject*& New);
	...
	static bool GetWorkingDir(FString& DirPath);
	...
	static bool DisablePluginAtRuntime(const FString PluginName);
	...
	static bool ReadRegeditValue(FString& OutRegedit, ERegeditRoot RegistryRoot, const FString KeyName, const FString ValueName);
	...
	static void ForceShutdownPC();

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Restart Application", Keywords = "restart, application"), Category = "Frozen Forest|Extended Variables|Windows|System")
	...
	static void SplashScreenVisibility(bool HideSplashScreen);
	...
	static bool SetClipboard(const FString& Input);
...
#pragma region Profiling
	...
	static void GetMonitorNamesFromPowershell(FString& Out_Path, FString& Out_Params);
	...
	static void GetMonitorInfos(FJsonObjectWrapper& OutMonitorInfos);
	...
	static void GetNetworkInfos(TArray<FString>& Out_Adapters, FString& OutHostname, FString& OutHostAddr, FString& OutMac);
	...
	static void GetCpuFromPowershell(FString&Out_Path, FString& Out_Params);
	...
	static void GetGpuFromPowershell(FString& Out_Path, FString& Out_Params);
	...
	static void GetNetworkFromPowershell(FString& Out_Path, FString& Out_Params);
...
#pragma region External_Apps
	...
	static bool RunExternalApp_Internal(FJsonObjectWrapper& Out_Result, FString AppPath, const FString& Parameters, bool bIsAdmin = false);
	...
	static void RunExternalApp(FDelegateTerminalResult DelegateResult, FString AppPath, const FString& Parameters, bool bIsAdmin = false);
	...
	static void RunExternalAppWithPipes(FDelegateTerminalResult DelegateResult, FDelegatePipes DelegatePipe, FString AppPath, const FString& Parameters);
